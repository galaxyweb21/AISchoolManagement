...
class StaffProfile(models.Model):
    ...
    signature_is_active = models.BooleanField(
        default=True,
        help_text="When enabled, this signature may be automatically placed on official report cards."
    )

    # Explicitly designate the school's headteacher/head of school.
    # Existing SCHOOL_ADMIN records remain a safe fallback for older data.
    is_headteacher = models.BooleanField(
        default=False,
