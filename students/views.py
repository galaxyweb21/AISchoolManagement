...
def edit_student(request, student_id):
    ...
    student.user.gender = request.POST.get('gender', student.user.gender or '').strip() or None
    profile_picture = request.FILES.get('profile_picture')
    if profile_picture:
        student.user.profile_picture = profile_picture
    student.user.save(update_fields=['first_name', 'last_name', 'email', 'gender', 'profile_picture'])
    ...
    student.save(update_fields=[
        'date_of_birth', 'grade_level', 'school_class', 'parent', 'enrollment_type',
